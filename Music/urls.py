...
urlpatterns = [
    ...
    # thebath/albums/
    url(r'albums/$', mus_views.albums),

    # thebath/albums/12/
    url(r'^albums/(?P<album_id>[0-9]+)/$', mus_views.details_album, name='details_album'),

    # thebath/albums/12/favourite/
    url(r'^albums/(?P<album_id>[0-9]+)/favourite/$', mus_views.favourite_album, name='favourite_album'),

    # thebath/albums/12/delete/
    url(r'^albums/(?P<album_id>[0-9]+)/delete/$', mus_views.delete_album, name='delete_album'),
    ...
    # thebath/artists/12/
    url(r'^artists/(?P<artist_id>[0-9]+)/$', mus_views.details_artist, name='details_artist'),

    # thebath/artists/12/delete/
    url(r'^artists/(?P<artist_id>[0-9]+)/delete/$', mus_views.delete_artist, name='delete_artist'),
    ...
    #thebath/genres/21/
    url(r'^genres/(?P<genre_id>[0-9]+)/$', mus_views.details_genre, name='details_genre'),

    #thebath/genres/21/
    url(r'^genres/(?P<genre_id>[0-9]+)/delete/$', mus_views.delete_genre, name='delete_genre'),
